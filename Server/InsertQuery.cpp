...
void InsertQuery::showSQLError(unsigned int handleType, const SQLHANDLE& handle)
{
...
void InsertQuery::ExecuteQuery()
{
	do {
		...
		if (SQL_SUCCESS != SQLSetConnectAttr(SQLConnectionHandle, SQL_LOGIN_TIMEOUT, (SQLPOINTER)5, 0))
			...
			break;
		string SQLQuerry = "INSERT INTO Clienti(Username,Password,Rol) VALUES ('" + getUsername() + "','" + getPassword() + "','" + getRank() + "');";
